...
def _run_gateway(
    ...
    *,
    ...
    omniagent_run_store = RunStore(config.workspace_path / "omniagent" / "runs.db")
    omniagent_run_store.initialize()
    omniagent_run_store.subscribe(runtime_events)
    ...
    agent = AgentLoop.from_config(
        ...
        hook_factories=[
            ...
            create_run_observability_hook(omniagent_run_store),
        ],
        tool_registry=tools,
    ...
    channels = ChannelManager(
        ...
        omniagent_run_store=omniagent_run_store,
