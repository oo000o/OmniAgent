...
> This fork includes **OmniAgent**, a private-knowledge and task-automation application
> built on the nanobot runtime. See the [OmniAgent project guide](./docs/omniagent-project.md)
> for its architecture, reproducible evaluation, Feishu demo, and engineering scope.
