...
rejection, rank fusion, career-workflow reliability, run observability aggregates, and
fault-injection recovery. The same report also compares BM25, deterministic vector
...
rejections, bounded plan revision, restart/idempotency recovery, and fault-injection
replays. These are deterministic
offline scenario rates—not production availability, traffic, or user-success metrics.
