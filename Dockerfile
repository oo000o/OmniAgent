...
ARG DEBIAN_MIRROR
ARG PYPI_INDEX_URL
ENV UV_DEFAULT_INDEX="$PYPI_INDEX_URL" PIP_INDEX_URL="$PYPI_INDEX_URL"
...
RUN mkdir -p nanobot evaluation && touch nanobot/__init__.py evaluation/__init__.py && \
